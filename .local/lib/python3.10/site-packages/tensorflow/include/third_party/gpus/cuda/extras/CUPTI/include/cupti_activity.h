 ...
 * header cupti_activity_deprecated.h, which is included at
...
typedef enum {
     ...
     *
     * Using page-locked (pinned) host memory buffers is not supported on confindential computing
     ...
     * Changing this attribute in the middle of the profiling session will result in undefined behaviour.
     *
     * The default value is 0.
     */
